...
Note: Be sure you are working within a [branch](https://thenewstack.io/dont-mess-with-the-master-working-with-branches-in-git-and-github/) of a given repository. Here are some [instructions on how to create a branch](https://docs.github.com/en/github/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/creating-and-deleting-branches-within-your-repository).

1. Symbolize the layer to your liking.

2. Once the layer has been symbolized, right click the layer within the layers panel.

3. Scroll down to *Export* and select *Save as QGIS Layer Style File* (Since QGIS doesn't recognize `.lyr` files, we will need to export our symbology as `.qml` files).
...
<YouTubeEmbed videoId="cbAsvdh7_Ws"/>
...
<YouTubeEmbed videoId="lxYP79fkAQY"/>
