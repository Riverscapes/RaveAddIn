...
You can override this behavior and apply specific symbology to different types of layers. For example you can use one raster symbology for DEMs and another for vegetation. The Viewer does this using layer files in ArcGIS and QML files in QGIS.
