...
The second location describes the list of the base maps that is deployed with the Viewer software. This list is updated with each release of the Viewer software.
