...
1. Download the latest [Riverscapes Viewer addinx file](https://github.com/Riverscapes/ArcProViewer/releases).
...
:::note
Updating Resources currently locks the ArcGIS Pro interface while it is downloading. Wait several minutes for the process to complete, after which time the user interface will become responsive again.
:::

## Minimum Requirements

The Riverscapes Viewer requires ArcGIS Pro 3.4 or above.

## Video Demonstration

<YouTubeEmbed videoId="x_U5ddaazbE?si=fvURbYOp9MyIHy_l"/>
