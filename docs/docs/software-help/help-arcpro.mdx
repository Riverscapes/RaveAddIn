...
See the instructions to [install the Riverscapes Viewer for ArcGIS Pro](/Deploy/install-arcpro) if you haven't already done so. See the video demonstration at the bottom of this page.
...
![add to map](/images/arcpro/main_map.png)
...
<YouTubeEmbed videoId="sRRNTVxAomQ?si=kFKNQqkRcx_ZlSJF"/>