  ...
  return (
    <div className={styles.container}>
      <section title="Home" className={styles.intro}>
        <p>
          Easily explore explore <a href="https://data.riverscapes.net">riverscape projects</a> as maps, with
          repeatable, curated symbology and meaningful layer organization.
        </p>

        <br />
        <h2>Consistent Cartography</h2>
        <p>
          Stop wasting time repeatedly symbolizing layers. Riverscapes Viewers automatically applies carefully curated
          symbology to data, ensuring the same look and feel every time.
        </p>

        <br />
        <h2>Logical Table of Contents</h2>
        <p>
          Data are presented in a meaningful hierarchy that is relevant to the type data you are looking at. Layers can
          be added to your current map and are automatically organized into a matching table of contents.
        </p>

        <br />
        <h2>Helpful MetaData</h2>
        <p>
          Riverscapes Viewers make it easy to see where data originated from and navigate to the source. Metadata is
          available for all layers, providing context and provenance.
        </p>
      </section>
