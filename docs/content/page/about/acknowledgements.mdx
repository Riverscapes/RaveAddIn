...
Part of what makes the Viewer useful is that layers are added to the map using consistent, meaingful symbology that has been carefully developed by the [Riverscapes Project Curators Team](github.com/orgs/Riverscapes/teams/riverscape-project-curators/members) based largely in the [Utah State University River Assessment and Monitoring Lab](http://etal.joewheaton.org).
