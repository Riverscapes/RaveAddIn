...
def get_brat_variables(brat_folder):
    ...
    in_dict['Roads'] = search_for_key(all_files, ["roads"])
    in_dict['Rails'] = search_for_key(all_files, ["rails"])
    ...
    out_dict['BRAT Table'] = search_for_key(all_files, ["BRAT_Table"], ["Perennial"])
